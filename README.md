...
Η **Ενεργειακή Αποδοτικότητα** είναι ο αριθμός των λειτουγιών που εκτελεί ένα σύστημα ανά μονάδα ενέργειας. Ο όρος αυτός είναι το μέτρο σύγκρισης των συστημάτων με διαφορετική υπολογιστική ισχύ και κατανάλωση. Ο λόγος αυτός είναι ανάλογος και με τον λόγο του χρόνου εκτέλεσης του ίδιου προγράμματος σε 2 συστήματα προς την μέση ισχύ που καταναλώνουν. Αυτό προκύπτει ως εξής:

  ```Evergy_effective=Instructions/Energy=Instructions/(Power_avg*time)=time/(Power_avg)*Instructions```

Επομένως γνωρίζοντας μόνο την κατανάλωση των 2 επεξεργαστών δεν μπορούμε να συμπεράνουμε ποιος είναι κατάλληλος για την χρήση του στο σύστημα αυτό αλλά χρειαζόμαστε και τον αριθμό των λειτουργιών που εκτελεί ο επεξεργαστής προς στην ενέργεια που καταναλώνει. Θεωρόντας ένα παράδειγμα, ο δεύτερος επεξεργαστής μπορεί να εκτελεί ένα πρόγραμμα 10 φορές πιο γρήγορα τότε ο πρώτος έχει 10*40/5=80 φορές καλύτερη ενεργειακή αποδοτικότητα.
